...
module.exports = {
  ...
  theme: "@jinyaoma/vuepress-theme-mustom",
  ...
  themeConfig: {
    ...
    clustrmaps: {
      ...
      src:
        "//cdn.clustrmaps.com/map_v2.js?cl=333333&w=a&t=t&co=ffffff&cmo=3acc3a&cmn=ff5353&ct=333333"
    },
    author: "jinyaoMa",
    ...
    notification: [
      {
        ...
        type: "default",
        msg: [
          "<strong>欢迎来到我的个人网站！技术交流请加 QQ 群：595614161，也可以加本人QQ：907881445<strong>", // zh
  ...
  configureWebpack: () => {
    if (process.env.NODE_ENV === "production") {
      return {
        output: {
          publicPath:
            "https://cdn.jsdelivr.net/gh/jinyaoMa/vuepress-theme-mustom-sample/"
        }
      };
    }
  }
